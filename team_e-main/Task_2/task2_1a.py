...
if __name__ == '__main__':
    ...
    pr = PyRep()
    pr.launch(f'/home/btknzn/Desktop/CoppeliaSim_Edu_V4_1_0_Ubuntu20_04/PyRep/examples/team_e-Assignment-2.1/scenes/panda_reach_cylinder.ttt', headless=False) 
    pr.start()
